...
from src_bot.models.domain_models import Method
from src_bot.utils.common import convert, read_file_content
from src_bot.utils.lsp_utils import process_lsp_results
...
class BaseCodeAnalyzer(ABC):
    ...
    def filter_builtin_items(self, items: list) -> list:
        from src_bot.config.java_constants import JavaBuiltinPackages
