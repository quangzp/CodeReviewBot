...
from src_bot.lsp.multilspy.language_server import LanguageServer
from src_bot.lsp.multilspy.lsp_protocol_handler.lsp_types import InitializeParams
from src_bot.lsp.multilspy.lsp_protocol_handler.server import ProcessLaunchInfo
from src_bot.lsp.multilspy.multilspy_config import MultilspyConfig
from src_bot.lsp.multilspy.multilspy_logger import MultilspyLogger
from src_bot.lsp.multilspy.multilspy_settings import MultilspySettings
from src_bot.lsp.multilspy.multilspy_utils import FileUtils
from src_bot.lsp.multilspy.multilspy_utils import PlatformUtils
...
class EclipseJDTLS(LanguageServer):
    ...
    async def start_server(self) -> AsyncIterator["EclipseJDTLS"]:
        ...
        async with super().start_server():
            ...
            self.logger.log(
                "Sending initialize request from src_bot.lsp client to LSP server and awaiting response",
                logging.INFO,
            )
