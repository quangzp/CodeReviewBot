...
from src_bot.extractors.base_extractor import AnnotationDependencyExtractor
from src_bot.extractors.java.kafka_extractor import KafkaAnnotationExtractor
from src_bot.extractors.java.rabbit_extractor import RabbitAnnotationExtractor
from src_bot.extractors.java.spring_event_extractor import EventAnnotationExtractor
from src_bot.extractors.java.springboot_annotation_extractor import SpringBootAnnotationExtractor
from src_bot.extractors.java.quarkus_extractor import QuarkusJaxRsExtractor
from src_bot.models.domain_models import RestEndpoint
